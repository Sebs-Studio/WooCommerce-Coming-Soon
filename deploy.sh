# main config
PLUGINSLUG="woocommerce-coming-soon" # returns basename of current directory
CURRENTDIR=`pwd`
MAINFILE="woocommerce-coming-soon.php" # this should be the name of your main php file in the wordpress plugin
